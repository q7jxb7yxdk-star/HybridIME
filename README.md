...
- iPad 在水平尺寸類別為 `regular` 且鍵盤寬度至少 700 點時使用 11 格寬版配置；扣除 iPadOS 額外提供的約 75 點系統輸入輔助列後，自訂內容在縱向使用 265 點、橫向使用 353 點，使整體可見高度分別貼近原生倉頡鍵盤的 340 點與 428 點。非寬版或浮動 iPad 的緊湊配置維持 260 點。
